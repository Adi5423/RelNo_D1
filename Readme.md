...
- [Perlin To OBJ Test](#Perlin-To-OBJ-Test)
...
## Perlin To OBJ Test
Test the package using the test case generated by uss to understand how easily it work beneath the level to final use case.


At [PerlinTo_OBJ Branch of RelNo_D1](https://github.com/Adi5423/RelNo_D1/tree/PerlinTo_OBJ)
We have tried a a simple Perlin Noise Map to to a real 3D terrain using no external library and just RelNo_D1.

* Clone the repo from PerlinTo_OBJ branch 
```bash
git clone --branch https://github.com/adi5423/relno_d1
cd RelNo_D1
```
then follow all the commands mentioned there to successfully build a 3D terrain .OBJ to view inside a 3D Editor like blender. 
